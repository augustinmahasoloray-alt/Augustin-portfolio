export const portfolioShared = {
  ...
  skills: [
    ...
    { id: "react", name: "React", category: "frontend", percentage: 30, badgeColor: "bg-violet-50 text-violet-700 border-violet-200" },
    ...
    { id: "kotlin", name: "Kotlin", category: "backend", percentage: 25, badgeColor: "bg-purple-50 text-purple-700 border-purple-200" },
    { id: "bcrypt", name: "Bcrypt", category: "backend", percentage: 70, badgeColor: "bg-slate-50 text-slate-700 border-slate-200" },
    { id: "mysql", name: "MySQL", category: "database", percentage: 50, badgeColor: "bg-cyan-50 text-cyan-700 border-cyan-200" },
